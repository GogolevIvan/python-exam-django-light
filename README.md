...
и кликабельное название сайта , ведущее на Главную страницу приложения? В этом примере это MyApplication.
...
ВАЖНО: Название приложения назвать по имени базы данных (не MyApplication).
...
10. Создать страницу одного товара и дополнительную страницу.
11. Вторая пара закончилась.
12. Настроить отображение страниц при переходе по ссылкам, исправить ошибки.
13. Создать доолнительное оформление.
14. Сдача и Защита работы.
